...
export class UnrecognizedInputKeyError extends BaseError {
    constructor(errors, props) {
        super('No format was able to recognize the input key', 'UnrecognizedInputKeyError', 'UNRECOGNIZED_INPUT_KEY', { ...props, errors });
    }
}
